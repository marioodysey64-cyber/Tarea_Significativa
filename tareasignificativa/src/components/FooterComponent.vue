  ...
  <footer class="footer">
    <div class="footer-container">
      ...
      <div class="footer-column">
        <div class="contact-item">
          ...
          <div class="contact-text">
            <h3>Instituto Salvadoreño Del Seguro Social</h3>
            <p>Alameda Juan Pablo II y 39 Avenida Norte, Edificio El Salvador, San Salvador, El Salvador.</p>
          </div>
        </div>
        ...
        <div class="contact-item">
          ...
          <div class="contact-text">
            <p>atencionalusuario@isss.gob.sv</p>
          </div>
        </div>
      </div>
      ...
      <div class="footer-column footer-logo">
          <img src="https://www.presidencia.gob.sv/wp-content/uploads/2019/05/logo-gris-oscuro-sin-fondo.png" alt="Gobierno de El Salvador" class="gobierno-logo">

      </div>

      <!-- Columna Derecha - Enlaces y Redes Sociales -->
